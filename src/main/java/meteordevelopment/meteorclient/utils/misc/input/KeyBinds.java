...
public class KeyBinds {
    private static final String CATEGORY = "Axolotl Client";

    public static KeyBinding OPEN_GUI = new KeyBinding("key.axolotl-client.open-gui", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_RIGHT_SHIFT, CATEGORY);
    public static KeyBinding OPEN_COMMANDS = new KeyBinding("key.axolotl-client.open-commands", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_PERIOD, CATEGORY);
